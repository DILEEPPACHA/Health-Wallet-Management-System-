...
def fetchPatient(request):
    if request.method == 'POST':
        ...
        try:
            ...
            s.starttls()
            s.login("dileeppacha9@gmail.com", "lhacrnclanyjeqlt")
            s.sendmail("dileeppacha9@gmail.com", pmail, msg)
            s.quit()
            print(pmail, msg)
...
# message to be sent
       ...
       """
        # sending the mail
       s.sendmail("dileeppacha9@gmail.com",mail, msg+m)
...
# sending the mail
        s.sendmail("dileeppacha9@gmail.com",email, msg+pname+msg2)

# terminating the session
        s.quit()
        return redirect('home')
    return render(request,"patientRegister.html",context={"msg":"register successfully"})
